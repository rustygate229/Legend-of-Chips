...
namespace _3902_Project
{
    public class ItemSpriteFactory
    {
        ...
        {
            return new ItemSprite(_itemSpritesheet, _position, 25,1, 13, 13);
        }

        public ISprite CreateLadder()
        {
            return new ItemSprite(_itemSpritesheet, _position, 208, 0, 16, 16);
        }
      
        public ISprite CreateWaterPlate()
        {
            return new ItemSprite(_itemSpritesheet, _position, 193, 0, 14, 16);
        }
