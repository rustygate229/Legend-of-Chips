...
namespace _3902_Project
{
    public class FacingBlockTemplate : ISprite
    {
        ...
        private Vector2 _spriteDownPosition = new Vector2(0, 0);
        private Vector2 _spriteDownDimensions = new Vector2(0, 0);

        private Vector2 _spriteUpPosition = new Vector2(0, 0);
        private Vector2 _spriteUpDimensions = new Vector2(0, 0);

        private Vector2 _spriteRightPosition = new Vector2(0, 0);
        private Vector2 _spriteRightDimensions = new Vector2(0, 0);

        private Vector2 _spriteLeftPosition = new Vector2(0, 0);
        private Vector2 _spriteLeftDimensions = new Vector2(0, 0);
