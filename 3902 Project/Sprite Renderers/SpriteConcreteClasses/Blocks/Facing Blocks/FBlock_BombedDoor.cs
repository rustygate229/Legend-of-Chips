...
namespace _3902_Project
{
    public class FBlock_BombedDoor : ISprite
    {
        ...
        private Vector2 _spriteDownPosition = new Vector2(947, 11);
        private Vector2 _spriteDownDimensions = new Vector2(32, 32);

        private Vector2 _spriteUpPosition = new Vector2(947, 110);
        private Vector2 _spriteUpDimensions = new Vector2(32, 32);

        private Vector2 _spriteRightPosition = new Vector2(947, 44);
        private Vector2 _spriteRightDimensions = new Vector2(32, 32);

        private Vector2 _spriteLeftPosition = new Vector2(947, 77);
