...
namespace _3902_Project
{
    public class FBlock_OpenDoor : ISprite
    {
        ...
        private Vector2 _spriteDownPosition = new Vector2(848, 11);
        private Vector2 _spriteDownDimensions = new Vector2(32, 32);

        private Vector2 _spriteUpPosition = new Vector2(848, 110);
        private Vector2 _spriteUpDimensions = new Vector2(32, 32);

        private Vector2 _spriteRightPosition = new Vector2(848, 44);
        private Vector2 _spriteRightDimensions = new Vector2(32, 32);

        private Vector2 _spriteLeftPosition = new Vector2(848, 77);
        ...
        /// </summary>
        public FBlock_OpenDoor(Texture2D spriteSheet, Renderer.DIRECTION facingDirection, float printScale)
        {
