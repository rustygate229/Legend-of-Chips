...
{
    public class SItem_Ladder : ISprite
    {
        // variables for constructor assignments
        private Vector2 _position;

        // variables to change based on where your item is and what to print out
        private Vector2 _spritePosition = new Vector2(208, 0);
        ...
        public SItem_Ladder(Texture2D spriteSheet, float printScale)
        {
            _item = new (Renderer.STATUS.Animated, spriteSheet, _spritePosition, _spriteDimensions, _spriteDimensions * printScale);
        }
