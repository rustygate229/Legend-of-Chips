...
namespace _3902_Project
{
    public class FacingBlockTemplate : ISprite
    {
        ...
        public FacingBlockTemplate(Texture2D spriteSheet, Vector2 spawnPosition, Renderer.DIRECTION facingDirection)
        {
        ...
        // update the movement for block, will be used later
        public void Update()
        {
        }
