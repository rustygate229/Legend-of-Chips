...
namespace _3902_Project
{
    public class FBlock_BombedDoor : ISprite
    {
        ...
        private Vector2 _spriteDownUpPosition = new Vector2(947, 11);
        private Vector2 _spriteDownUpDimensions = new Vector2(32, 32);

        private Vector2 _spriteRightLeftPosition = new Vector2(947, 44);
        ...
        /// </summary>
        public FBlock_BombedDoor(Texture2D spriteSheet, Renderer.DIRECTION facingDirection)
        {
