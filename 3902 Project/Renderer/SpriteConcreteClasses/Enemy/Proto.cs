...
namespace _3902_Project
{
    public class Proto : ISprite
    {
        ...
        public Proto (Texture2D spriteSheet, Vector2 startPosition)
        {
            _spriteSheet = spriteSheet;
            _position = startPosition;
            _enemy = new Renderer(Renderer._status.Animated, _spriteSheet, _position, 300, 194, 33, 16, 64, 64, 1, 2, 30);
        }
