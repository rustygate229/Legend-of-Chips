...
namespace _3902_Project
{
    public class BrownSlime : ISprite
    {
        ...
        public BrownSlime(Texture2D spriteSheet, Vector2 startPosition)
        {
            _spriteSheet = spriteSheet;
            _position = startPosition;
            _enemy = new Renderer(Renderer._status.Animated, _spriteSheet, _position, 79, 28, 30, 16, 64, 64, 1, 2, 30);
        }
