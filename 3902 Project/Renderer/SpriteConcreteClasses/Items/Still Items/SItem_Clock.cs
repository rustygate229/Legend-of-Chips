...
{
    public class SItem_Clock : ISprite
    {
        ...
        private Vector2 _spritePosition = new Vector2(58, 0);
        private Vector2 _spriteDimensions = new Vector2(11, 16);
        private Vector2 _spritePrintDimensions = new Vector2(22, 32);
        ...
        public SItem_Clock(Texture2D spriteSheet)
        {
