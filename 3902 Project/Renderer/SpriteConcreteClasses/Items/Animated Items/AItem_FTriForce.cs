...
{
    public class AItem_FTriForce : ISprite
    {
        ...
        private Vector2 _spritePosition = new Vector2(272, 0);
        private Vector2 _spriteDimensions = new Vector2(16, 32);
        private Vector2 _spritePrintDimensions = new Vector2(32, 32);
        ...
        public AItem_FTriForce(Texture2D spriteSheet)
        {
