...
{
    public class AItem_DepletingHeart : ISprite
    {
        // variables to change based on where your item is and what to print out
        private Rectangle _spritePosition = new (0, 0, 24, 8);
        ...
        public AItem_DepletingHeart(Texture2D spriteSheet, float printScale)
        {
