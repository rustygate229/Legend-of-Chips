...
{
    public class FadeOut_Total : ISprite
    {
        ...
        private Rectangle _leftDestinationRectangle = new(0, 0, 530, 900);
        private Rectangle _rightDestinationRectangle = new(530, 0, 530, 900);
        ...
        public FadeOut_Total(Texture2D spriteSheet)
        {
