...
{
    public class FadeIn_Partial : ISprite
    {
        ...
        private Rectangle _leftDestinationRectangle = new(-530, 196, 530, 804);
        private Rectangle _rightDestinationRectangle = new(1024, 196, 530, 804);
        ...
        public FadeIn_Partial(Texture2D spriteSheet)
        {
