...
{
    public class PSprite_MasterSword : ISprite
    {
        // variables to change based on where your projectile is and what to print out
        private Rectangle _spriteDownUpPositions = new(71, 154, 7, 16);
        private Rectangle _spriteRightLeftPositions = new(80, 159, 16, 7);
        ...
        public PSprite_MasterSword(Texture2D spriteSheet, Renderer.DIRECTION direction, float printScale, int timerTotal)
        {
            // create renders of the bomb projectile
            Renderer masterSwordDownUp = new(spriteSheet, _spriteDownUpPositions, printScale);
            Renderer masterSwordRightLeft = new(spriteSheet, _spriteRightLeftPositions, printScale);
            Renderer[] rendererList = { masterSwordDownUp, masterSwordRightLeft };
