...
{
    public class PSprite_DebugSword : ISprite
    {
        // variables to change based on where your projectile is and what to print out
        private Rectangle _spriteDownUpPositions = new(106, 154, 7, 16);
        private Rectangle _spriteRightLeftPositions = new(115, 159, 16, 7);
        ...
        public PSprite_DebugSword(Texture2D spriteSheet, Renderer.DIRECTION direction, float printScale, int timerTotal)
        {
            // create renders of the bomb projectile
            Renderer debugSwordDownUp = new(spriteSheet, _spriteDownUpPositions, printScale);
            Renderer debugSwordRightLeft = new(spriteSheet, _spriteRightLeftPositions, printScale);
            Renderer[] rendererList = { debugSwordDownUp, debugSwordRightLeft };
