...
namespace _3902_Project
{
    public class FBlock_OpenDoor : ISprite
    {
        ...
        private Rectangle _spriteDownPosition = new (848, 11, 32, 32);
        private Rectangle _spriteUpPosition = new (848, 110, 32, 32);
        private Rectangle _spriteRightPosition = new (848, 44, 32, 32);
        private Rectangle _spriteLeftPosition = new (848, 77, 32, 32);
