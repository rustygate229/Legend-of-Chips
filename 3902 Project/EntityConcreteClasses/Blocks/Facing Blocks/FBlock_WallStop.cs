...
{
    public class FBlock_WallStop : ISprite
    {
        // variables to change based on where your block is and what to print out
        private Rectangle _spriteDownPosition = new (815, 11, 32, 32);
        private Rectangle _spriteUpPosition = new (815, 110, 32, 32);
        private Rectangle _spriteRightPosition = new (815, 44, 32, 32);
        private Rectangle _spriteLeftPosition = new (815, 77, 32, 32);
        ...
        /// </summary>
        public FBlock_WallStop(Texture2D spriteSheet, Renderer.DIRECTION facingDirection, float printScale)
        {
