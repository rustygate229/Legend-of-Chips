...
namespace _3902_Project
{
    public class FBlock_KeyHoleLockedDoor : ISprite
    {
        ...
        private Rectangle _spriteDownPosition = new (881, 11, 32, 32);
        private Rectangle _spriteUpPosition = new (881, 110, 32, 32);
        private Rectangle _spriteRightPosition = new (881, 44, 32, 32);
        private Rectangle _spriteLeftPosition = new (881, 77, 32, 32);
