...
namespace _3902_Project
{
    public class FBlock_BombedDoor : ISprite
    {
        ...
        private Rectangle _spriteDownPosition = new (947, 11, 64, 64);
        private Rectangle _spriteUpPosition = new (947, 110, 64, 64);
        private Rectangle _spriteRightPosition = new (947, 44, 64, 64);
        private Rectangle _spriteLeftPosition = new (947, 77, 64, 64);
