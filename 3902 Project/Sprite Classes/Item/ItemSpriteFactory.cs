...
namespace _3902_Project
{
    public class ItemSpriteFactory
    {
        ...
        public ISprite CreateStaticItem_FullHeart() { return new ItemSprite(_itemSpritesheet, _position, 25, 1, 13, 13); }
        
        public ISprite CreateStaticItem_Clock() { return new ItemSprite(_itemSpritesheet, _position, 58, 0, 11, 16); }

        public ISprite CreateStaticItem_Meat() { return new ItemSprite(_itemSpritesheet, _position, 96, 0, 8, 16); }

        public ISprite CreateStaticItem_Sword() { return new ItemSprite(_itemSpritesheet, _position, 112, 0, 8, 16); }

        public ISprite CreateStaticItem_Shield() { return new ItemSprite(_itemSpritesheet, _position, 120, 0, 8, 16); }

        public ISprite CreateStaticItem_Bomb() { return new ItemSprite(_itemSpritesheet, _position, 136, 0, 8, 16); }

        public ISprite CreateStaticItem_Bow() { return new ItemSprite(_itemSpritesheet, _position, 144, 0, 8, 16); }

        public ISprite CreateStaticItem_Horn() { return new ItemSprite(_itemSpritesheet, _position, 176, 0, 8, 16); }

        public ISprite CreateStaticItem_Flute() { return new ItemSprite(_itemSpritesheet, _position, 184, 0, 8, 16); }

        public ISprite CreateStaticItem_WaterPlate() { return new ItemSprite(_itemSpritesheet, _position, 193, 0, 14, 16); }

        public ISprite CreateStaticItem_Ladder() { return new ItemSprite(_itemSpritesheet, _position, 208, 0, 16, 16); }

        public ISprite CreateStaticItem_MagicStaff() { return new ItemSprite(_itemSpritesheet, _position, 224, 0, 8, 16); }

        public ISprite CreateStaticItem_Game() { return new ItemSprite(_itemSpritesheet, _position, 232, 0, 8, 16); }

        public ISprite CreateStaticItem_NormalKey() { return new ItemSprite(_itemSpritesheet, _position, 240, 0, 8, 16); }

        public ISprite CreateStaticItem_BossKey() { return new ItemSprite(_itemSpritesheet, _position, 248, 0, 8, 16); }

        public ISprite CreateStaticItem_Compass() { return new ItemSprite(_itemSpritesheet, _position, 256, 0, 16, 16); }
